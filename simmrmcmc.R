simmr_mcmc = function(simmr_in, prior.control=list(means=rep(0,simmr_in$n_sources),sd=rep(1,simmr_in$n_sources)), mcmc.control=list(iter=50000,burn=1000,thin=10,n.chain=4)) {
